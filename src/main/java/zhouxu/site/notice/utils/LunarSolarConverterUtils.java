...
class Lunar {
     ...
     * @Param [date]
     * @return zhouxu.site.notice.utils.Lunar
     * @throws
     **/
    public static Lunar getLunar(Date date){
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        return new Lunar(calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH)+1,calendar.get(Calendar.DATE));
    }

    /**
     * @Author zhouxu
     * @Description //阴历转日期日期对象
     * @Date 2018/12/25 9:58
     * @Param [lunar]
     * @return java.util.Date
     * @throws
     **/
    public static Date getDate(Lunar lunar) throws ParseException {
        String dateStr=lunar.lunarYear+"-"+lunar.lunarMonth+"-"+lunar.lunarDay;
...
class Solar {
     ...
     * @throws
     **/
    public static Solar getSolar(Date date){
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        return new Solar(calendar.get(Calendar.YEAR),calendar.get(Calendar.MONTH)+1,calendar.get(Calendar.DATE));
    }

    /**
     * @Author zhouxu
     * @Description //阳历转日期日期对象
     * @Date 2018/12/25 9:58
     * @Param [lunar]
     * @return java.util.Date
     * @throws
     **/
    public static Date getDate(Solar solar) throws ParseException {
        String dateStr=solar.solarYear+"-"+solar.solarMonth+"-"+solar.solarDay;
        return DateUtils.parse(dateStr);
    }
 ...
 * Description:农历(阴历)和公历(阳历)转换工具类
 * User: zhouxu
 * Date: 2018-12-24 22:18
 */
public class LunarSolarConverterUtils {
     ...
     * @Param [lunar]
     * @return zhouxu.site.notice.utils.Solar
     * @throws
     **/
    public static Date lunarToSolar(Date date) throws ParseException {
        Lunar lunar = Lunar.getLunar(date);
        Solar solar = lunarToSolar(lunar);
        return Solar.getDate(solar);
    }
     ...
     * @throws
     **/
    public static Date solarToLunar(Date date) throws ParseException {
        Solar solar = Solar.getSolar(date);
        Lunar lunar = solarToLunar(solar);
        return Lunar.getDate(lunar);
    }
    /**
     * @Author zhouxu
     * @Description //公历转农历
